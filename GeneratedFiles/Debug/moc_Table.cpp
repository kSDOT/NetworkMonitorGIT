...
QT_MOC_LITERAL(3, 22, 6), // "addRow"
QT_MOC_LITERAL(4, 29, 28) // "std::vector<QList<QString> >"

    },
    "sta::Table\0clearData\0\0addRow\0"
    "std::vector<QList<QString> >"
};
...
void sta::Table::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addRow((*reinterpret_cast< const std::vector<QList<QString> >(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject sta::Table::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_sta__Table.data,
      qt_meta_data_sta__Table,  qt_static_metacall, nullptr, nullptr}
};
