...
QT_MOC_LITERAL(4, 59, 12), // "futureCancel"
QT_MOC_LITERAL(5, 72, 14), // "toolbarMessage"
QT_MOC_LITERAL(6, 87, 20), // "newAddapterClearData"
QT_MOC_LITERAL(7, 108, 12), // "selectDevice"
QT_MOC_LITERAL(8, 121, 12), // "startCapture"
QT_MOC_LITERAL(9, 134, 16) // "updateDeviceList"

    },
    "sta::NetworkManager\0dataRead\0\0"
    "std::vector<QList<QString> >\0futureCancel\0"
    "toolbarMessage\0newAddapterClearData\0"
    "selectDevice\0startCapture\0updateDeviceList"
};
...
static const uint qt_meta_data_sta__NetworkManager[] = {
 ...
 // signals: name, argc, parameters, tag, flags
       ...
       5,    1,   67,    2, 0x26 /* Public | MethodCloned */,
...
void sta::NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->futureCancel(); break;
        case 2: _t->toolbarMessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->toolbarMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->newAddapterClearData(); break;
        case 5: _t->selectDevice((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->startCapture(); break;
        case 7: _t->updateDeviceList(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkManager::futureCancel)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            typedef void (NetworkManager::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkManager::newAddapterClearData)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 1
void sta::NetworkManager::futureCancel()
{
...
// SIGNAL 4
void sta::NetworkManager::newAddapterClearData()
{
